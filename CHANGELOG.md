...
- **deps**: update module github.com/stretchr/testify to v1.12.0 ([80d57e3](https://gitlab.com/phpboyscout/go/config/-/commit/80d57e39ddc8e07f1c1176eceb6c19da290c1312))
...
- **deps**: update module gitlab.com/phpboyscout/go/yamldoc to v0.2.1 ([2305c41](https://gitlab.com/phpboyscout/go/config/-/commit/2305c412e536bbcc8c74a6e53033eed94f0df4d4))

## [v0.13.2](https://gitlab.com/phpboyscout/go/config/-/releases/v0.13.2)

[Compare to previous version](https://gitlab.com/phpboyscout/go/config/-/compare/v0.13.1...v0.13.2)

### Bug Fixes

- **deps**: update module gitlab.com/phpboyscout/go/errors to v0.2.0 ([238341c](https://gitlab.com/phpboyscout/go/config/-/commit/238341c432e40fb6c31b3d8de9ee4e83a592f7f3))

## [v0.13.1](https://gitlab.com/phpboyscout/go/config/-/releases/v0.13.1)

[Compare to previous version](https://gitlab.com/phpboyscout/go/config/-/compare/v0.13.0...v0.13.1)

### Bug Fixes

- **deps**: update module gitlab.com/phpboyscout/go/yamldoc to v0.2.0 ([ea6b6b9](https://gitlab.com/phpboyscout/go/config/-/commit/ea6b6b9a1cb23d71a1023b37d434898ab325649e))
...
- **deps**: update module gitlab.com/phpboyscout/go/yamldoc to v0.1.4 ([3711661](https://gitlab.com/phpboyscout/go/config/-/commit/3711661ea75960ff58b401a16397fd4473d0598b))
